...
public class msg_camera_feedback extends MAVLinkMessage {
     ...
     */
    public msg_camera_feedback( long time_usec, int lat, int lng, float alt_msl, float alt_rel, float roll, float pitch, float yaw, float foc_len, int img_idx, short target_system, short cam_idx, short flags) {
        this.msgid = MAVLINK_MSG_ID_CAMERA_FEEDBACK;
     ...
     */
    public msg_camera_feedback( long time_usec, int lat, int lng, float alt_msl, float alt_rel, float roll, float pitch, float yaw, float foc_len, int img_idx, short target_system, short cam_idx, short flags, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_CAMERA_FEEDBACK;
        this.sysid = sysid;
        this.compid = compid;
