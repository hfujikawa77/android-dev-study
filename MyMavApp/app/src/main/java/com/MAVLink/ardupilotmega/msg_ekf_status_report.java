...
public class msg_ekf_status_report extends MAVLinkMessage {
     ...
     */
    public msg_ekf_status_report( float velocity_variance, float pos_horiz_variance, float pos_vert_variance, float compass_variance, float terrain_alt_variance, int flags) {
        this.msgid = MAVLINK_MSG_ID_EKF_STATUS_REPORT;
     ...
     */
    public msg_ekf_status_report( float velocity_variance, float pos_horiz_variance, float pos_vert_variance, float compass_variance, float terrain_alt_variance, int flags, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_EKF_STATUS_REPORT;
        this.sysid = sysid;
        this.compid = compid;
