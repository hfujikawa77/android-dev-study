...
public class msg_vicon_position_estimate extends MAVLinkMessage {
     ...
     */
    public msg_vicon_position_estimate( long usec, float x, float y, float z, float roll, float pitch, float yaw) {
        this.msgid = MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE;
     ...
     */
    public msg_vicon_position_estimate( long usec, float x, float y, float z, float roll, float pitch, float yaw, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_VICON_POSITION_ESTIMATE;
        this.sysid = sysid;
        this.compid = compid;
