...
public class msg_rc_channels_override extends MAVLinkMessage {
     ...
     */
    public msg_rc_channels_override( int chan1_raw, int chan2_raw, int chan3_raw, int chan4_raw, int chan5_raw, int chan6_raw, int chan7_raw, int chan8_raw, short target_system, short target_component) {
        this.msgid = MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE;
     ...
     */
    public msg_rc_channels_override( int chan1_raw, int chan2_raw, int chan3_raw, int chan4_raw, int chan5_raw, int chan6_raw, int chan7_raw, int chan8_raw, short target_system, short target_component, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_RC_CHANNELS_OVERRIDE;
        this.sysid = sysid;
        this.compid = compid;
