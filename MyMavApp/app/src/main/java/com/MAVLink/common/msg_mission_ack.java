...
public class msg_mission_ack extends MAVLinkMessage {
     ...
     */
    public msg_mission_ack( short target_system, short target_component, short type) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ACK;
     ...
     */
    public msg_mission_ack( short target_system, short target_component, short type, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ACK;
        this.sysid = sysid;
        this.compid = compid;
