...
public class msg_mission_write_partial_list extends MAVLinkMessage {
     ...
     */
    public msg_mission_write_partial_list( short start_index, short end_index, short target_system, short target_component) {
        this.msgid = MAVLINK_MSG_ID_MISSION_WRITE_PARTIAL_LIST;
     ...
     */
    public msg_mission_write_partial_list( short start_index, short end_index, short target_system, short target_component, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_MISSION_WRITE_PARTIAL_LIST;
        this.sysid = sysid;
        this.compid = compid;
