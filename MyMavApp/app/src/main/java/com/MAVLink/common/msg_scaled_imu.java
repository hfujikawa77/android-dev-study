...
public class msg_scaled_imu extends MAVLinkMessage {
     ...
     */
    public msg_scaled_imu( long time_boot_ms, short xacc, short yacc, short zacc, short xgyro, short ygyro, short zgyro, short xmag, short ymag, short zmag) {
        this.msgid = MAVLINK_MSG_ID_SCALED_IMU;
     ...
     */
    public msg_scaled_imu( long time_boot_ms, short xacc, short yacc, short zacc, short xgyro, short ygyro, short zgyro, short xmag, short ymag, short zmag, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_SCALED_IMU;
        this.sysid = sysid;
        this.compid = compid;
