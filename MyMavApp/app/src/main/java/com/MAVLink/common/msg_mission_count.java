...
public class msg_mission_count extends MAVLinkMessage {
     ...
     */
    public msg_mission_count( int count, short target_system, short target_component) {
        this.msgid = MAVLINK_MSG_ID_MISSION_COUNT;
     ...
     */
    public msg_mission_count( int count, short target_system, short target_component, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_MISSION_COUNT;
        this.sysid = sysid;
        this.compid = compid;
