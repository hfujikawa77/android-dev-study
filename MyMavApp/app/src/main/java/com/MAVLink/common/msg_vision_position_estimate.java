...
public class msg_vision_position_estimate extends MAVLinkMessage {
     ...
     */
    public msg_vision_position_estimate( long usec, float x, float y, float z, float roll, float pitch, float yaw) {
        this.msgid = MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE;
     ...
     */
    public msg_vision_position_estimate( long usec, float x, float y, float z, float roll, float pitch, float yaw, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_VISION_POSITION_ESTIMATE;
        this.sysid = sysid;
        this.compid = compid;
