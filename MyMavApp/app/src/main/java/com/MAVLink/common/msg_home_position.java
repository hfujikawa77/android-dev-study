...
public class msg_home_position extends MAVLinkMessage {
     ...
     */
    public msg_home_position( int latitude, int longitude, int altitude, float x, float y, float z, float[] q, float approach_x, float approach_y, float approach_z) {
        this.msgid = MAVLINK_MSG_ID_HOME_POSITION;
     ...
     */
    public msg_home_position( int latitude, int longitude, int altitude, float x, float y, float z, float[] q, float approach_x, float approach_y, float approach_z, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_HOME_POSITION;
        this.sysid = sysid;
        this.compid = compid;
