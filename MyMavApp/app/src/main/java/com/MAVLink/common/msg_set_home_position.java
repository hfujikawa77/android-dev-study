...
public class msg_set_home_position extends MAVLinkMessage {
     ...
     */
    public msg_set_home_position( int latitude, int longitude, int altitude, float x, float y, float z, float[] q, float approach_x, float approach_y, float approach_z, short target_system) {
        this.msgid = MAVLINK_MSG_ID_SET_HOME_POSITION;
     ...
     */
    public msg_set_home_position( int latitude, int longitude, int altitude, float x, float y, float z, float[] q, float approach_x, float approach_y, float approach_z, short target_system, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_SET_HOME_POSITION;
        this.sysid = sysid;
        this.compid = compid;
