...
public class msg_att_pos_mocap extends MAVLinkMessage {
     ...
     */
    public msg_att_pos_mocap( long time_usec, float[] q, float x, float y, float z) {
        this.msgid = MAVLINK_MSG_ID_ATT_POS_MOCAP;
     ...
     */
    public msg_att_pos_mocap( long time_usec, float[] q, float x, float y, float z, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_ATT_POS_MOCAP;
        this.sysid = sysid;
        this.compid = compid;
