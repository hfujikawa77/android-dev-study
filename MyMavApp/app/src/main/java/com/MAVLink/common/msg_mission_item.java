...
public class msg_mission_item extends MAVLinkMessage {
     ...
     */
    public msg_mission_item( float param1, float param2, float param3, float param4, float x, float y, float z, int seq, int command, short target_system, short target_component, short frame, short current, short autocontinue) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ITEM;
     ...
     */
    public msg_mission_item( float param1, float param2, float param3, float param4, float x, float y, float z, int seq, int command, short target_system, short target_component, short frame, short current, short autocontinue, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ITEM;
        this.sysid = sysid;
        this.compid = compid;
    ...
    public String toString() {
        return "MAVLINK_MSG_ID_MISSION_ITEM - sysid:"+sysid+" compid:"+compid+" param1:"+param1+" param2:"+param2+" param3:"+param3+" param4:"+param4+" x:"+x+" y:"+y+" z:"+z+" seq:"+seq+" command:"+command+" target_system:"+target_system+" target_component:"+target_component+" frame:"+frame+" current:"+current+" autocontinue:"+autocontinue+"";
    }
