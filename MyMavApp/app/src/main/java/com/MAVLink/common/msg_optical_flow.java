...
public class msg_optical_flow extends MAVLinkMessage {
     ...
     */
    public msg_optical_flow( long time_usec, float flow_comp_m_x, float flow_comp_m_y, float ground_distance, short flow_x, short flow_y, short sensor_id, short quality) {
        this.msgid = MAVLINK_MSG_ID_OPTICAL_FLOW;
     ...
     */
    public msg_optical_flow( long time_usec, float flow_comp_m_x, float flow_comp_m_y, float ground_distance, short flow_x, short flow_y, short sensor_id, short quality, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_OPTICAL_FLOW;
        this.sysid = sysid;
        this.compid = compid;
