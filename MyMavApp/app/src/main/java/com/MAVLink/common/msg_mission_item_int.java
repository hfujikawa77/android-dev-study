...
public class msg_mission_item_int extends MAVLinkMessage {
     ...
     */
    public msg_mission_item_int( float param1, float param2, float param3, float param4, int x, int y, float z, int seq, int command, short target_system, short target_component, short frame, short current, short autocontinue) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ITEM_INT;
     ...
     */
    public msg_mission_item_int( float param1, float param2, float param3, float param4, int x, int y, float z, int seq, int command, short target_system, short target_component, short frame, short current, short autocontinue, int sysid, int compid, boolean isMavlink2) {
        this.msgid = MAVLINK_MSG_ID_MISSION_ITEM_INT;
        this.sysid = sysid;
        this.compid = compid;
