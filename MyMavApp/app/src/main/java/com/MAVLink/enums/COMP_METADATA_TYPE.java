...
public class COMP_METADATA_TYPE {
   public static final int COMP_METADATA_TYPE_GENERAL = 0; /* General information about the component. General metadata includes information about other COMP_METADATA_TYPEs supported by the component. This type must be supported and must be downloadable from vehicle. | */
