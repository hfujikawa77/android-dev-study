...
public class MAV_FRAME {
   ...
   public static final int MAV_FRAME_BODY_FRD = 12; /* FRD local tangent frame (x: Forward, y: Right, z: Down) with origin that travels with vehicle. The forward axis is aligned to the front of the vehicle in the horizontal plane. | */
