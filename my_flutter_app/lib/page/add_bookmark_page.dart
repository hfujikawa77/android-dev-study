...
class _AddBookmarkPageState extends State<AddBookmarkPage> {
  List<Bookmark> bookmarksList = [
    ...
    Bookmark("Google1", "https://google.com"),
    Bookmark("Google2", "https://google.com"),
    Bookmark("Google3", "https://google.com"),
    Bookmark("Google4", "https://google.com"),
  ];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text("新しいブックマークを追加してください。")),
